...
// ============================================================================
// Resource Validation (foundry_validate)
// ============================================================================
...
// ============================================================================
// External Plugins (foundry_external)
// ============================================================================
...
// ============================================================================
// Resource Versioning (foundry_version)
// ============================================================================
  ...
  if (action === "history") {
    ...
    try {
      const { stdout } = await execAsync(
        `git log --oneline -10 -- "${resourcePath}"`,
        { cwd: goldenPath }
      );
...
// ============================================================================
// Multiple Templates (foundry_templates)
// ============================================================================
...
async function main() {
  ...
  server.setRequestHandler(CallToolRequestSchema, async (request) => {
    ...
    if (isServiceNowTool(name)) {
      const result = await handleServiceNowTool(name, (args || {}) as Record<string, unknown>);
      if (result) {
        return result;
      }
    }
    ...
    if (name === "foundry_init") {
      ...
      const template = (args?.template as string) || "sparc-starter";
    ...
    if (name === "foundry_list") {
      const resourceType = (args?.type as string) || "all";
    ...
    if (name === "foundry_add") {
      const resourceType = args?.type as string;
