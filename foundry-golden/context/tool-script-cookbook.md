...
|---|--------|-----------|----------------|
| 1 | Get Single Record | Read one record by identifier | Autonomous |
| 2 | Query and Summarize | Query multiple + summarize results | Autonomous |
| 3 | Create Record | Insert a new record | Supervised |
| 4 | Update Fields | Modify existing record | Supervised |
| 5 | Query with Aggregation | Count, group, and summarize | Autonomous |
| 6 | Call REST API | Outbound REST call | Supervised |
| 7 | Chain Operations | Multi-step read-then-act | Supervised |
| 8 | Conditional Logic | Branching based on data | Autonomous |
| 9 | Voice-Compatible Script | String-only I/O for voice agents | Autonomous |
| 10 | Bulk Operations | Process multiple records | Supervised |
| 11 | Reference Field Resolution | Follow reference chains | Autonomous |
| 12 | Date-Based Filtering | Time-relative queries | Autonomous |
...
(function(inputs) {
    ...
    try {
        ...
        if (inputs.work_notes) {
            gr.setValue('work_notes', String(inputs.work_notes));
...
(function(inputs) {
    ...
    try {
        ...
        gr.setValue('work_notes', "Auto-categorized as '" + matchedCategory + "' based on keyword analysis. Assigned to " + groupName + ".");
        gr.update();
...
- [ ] Execution mode is Supervised for any write operations
